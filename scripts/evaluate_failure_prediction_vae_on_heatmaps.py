...
def evaluate_failure_prediction(cfg, heatmap_type, simulation_name, aggregation_method):
    ...
    name_of_losses_file = "track1-VAE-latent16-heatmaps-" + heatmap_type + '-' + cfg.SIMULATION_NAME
    ...
    for seconds in range(1, 7):
        ...
        if not os.path.exists("track1-VAE-latent16-heatmaps-" + heatmap_type + '.csv'):
            with open("track1-VAE-latent16-heatmaps-" + heatmap_type + '.csv', mode='w', newline='') as result_file:
            ...
            with open("track1-VAE-latent16-heatmaps-" + heatmap_type + '.csv', mode='a', newline='') as result_file:
                writer = csv.writer(result_file,
                                    delimiter=',',
                                    quotechar='"',
                                    quoting=csv.QUOTE_MINIMAL,
